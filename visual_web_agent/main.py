...
# ── Env utilities extracted to phases/_env_utils.py ──
from .phases._env_utils import (  # noqa: E402
    _env_or_default,
    _env_flag,
    _env_int,
    _split_env_keywords,
...
# ── Decision helpers extracted to phases/decision_helpers.py ──
from .phases.decision_helpers import (  # noqa: E402
    _goal_prefers_visual_navigation,
    _goal_should_force_vision,
    _should_fallback_to_vision,
    _find_target_line,
    _decision_is_irrelevant_nav_click,
    _goal_is_bulk_extraction,
    _decision_click_targets_extraction_control,
    _goal_explicitly_requests_voice_or_camera,
    _goal_is_plain_search_task,
    _decision_is_auxiliary_search_control_click,
    _decision_is_non_submit_search_control_click,
    _search_goal_done_looks_premature,
    _decision_implies_completion,
    _decision_mentions_follow_up_work,
    _decision_claims_current_subgoal_completed,
    _decision_should_finish_instead_of_operate,
    _done_targets_final_subgoal,
    _is_terminal_only_subgoal,
    _goal_explicitly_requests_backtracking,
    _decision_is_regressive_backtrack,
    _force_done_decision,
    _clean_user_visible_done_message,
)


# ── Answer domain functions extracted to phases/answer_domain.py ──
from .phases.answer_domain import (  # noqa: E402
    _format_extracted_rows_as_answer,
    _clean_weather_city_candidate,
    _extract_weather_city_from_goal,
    _infer_answer_weather_search_query,
    _baidu_query_from_url,
    _is_baidu_url,
    _normalize_search_query,
    _infer_answer_stock_search_query,
    _infer_answer_recipe_search_query,
    _infer_answer_flight_search_query,
    _build_answer_search_fast_path_url,
    _maybe_run_answer_search_fast_path,
    _city_regex_for_weather_text,
    _normalize_weather_temperature,
    _compose_weather_answer,
    _compact_weather_answer_from_text,
    _detect_answer_domain,
    _extract_stock_subject_from_goal,
    _compact_stock_answer_for_goal,
    _extract_recipe_name_from_goal,
    _compact_recipe_answer_for_goal,
    _extract_flight_number_from_goal,
    _compact_flight_answer_for_goal,
    _compact_answer_text_for_goal,
)


# ── RPA replay functions extracted to phases/rpa_replay.py ──
from .phases.rpa_replay import (  # noqa: E402
    _compact_rpa_trail,
    _is_dynamic_content_step,
    _resolve_composite_locator,
    _normalize_rpa_cache_payload,
    _extract_placeholder_keys,
    _stable_memory_keys,
    _resolve_replay_template,
    _write_rpa_cache_payload,
    _mark_rpa_cache_failure,
    _replay_switch_system,
    _replay_rpa,
    _replay_ready_rpa_steps,
    _print_manual_warning,
)

# ── CLI config functions extracted to phases/cli_config.py ──
from .phases.cli_config import (  # noqa: E402
    _runtime_config_module,
    _apply_runtime_overrides,
    _parse_cli_json_object,
    _build_cli_run_constraints,
    _build_cli_vlm_options,
    _resolve_action_tool_metadata,
)
